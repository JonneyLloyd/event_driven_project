...
AnimatedGraphicsTile::AnimatedGraphicsTile(QPixmap *textureSheet, int tileRow, int tileCol, int numberOfFrames, int duration, int tileSize, QGraphicsItem *parent)
